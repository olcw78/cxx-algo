...
#pragma endregion strlen
        ...
        cout << boolalpha
             << "'ma' starts since at " << str1_index
             << " and it is at string::npos? " << str1_index_at_npos << '\n'
             << "'o' starts since at " << str2_index
             << " and it is at string::npos? " << str2_index_at_npos << '\n'
             << "'_' starts since at " << str3_index
             << " and it is at string::npos? " << str3_index_at_npos;
